...
# the next.
#
# Modified version for revalidating 2015 5TeV fills.
...
emailTargets = {'pltzero': 'pltzero', 'bcm1f': 'bcm1f', 'hfet': 'hf', 'hfoc': 'hf', 'dt': 'dt', 'pcc': 'pcc', 'ramses': 'ramses'}
...
summaryEmailRecipients = ['david.peter.stickland@cern.ch', 'anne.evelyn.dabrowski@cern.ch', 'paul.lujan@cern.ch', 'georgios.krintiras@cern.ch'] 

# Paths to various things.
lumiValidatePath = "./lumiValidate_5TeV2015.py"     # script for making fill validation plot
fillListFile = "./fills_5TeV2015.txt"              # list of 5TeV2015 fills
logFileName = "./fillValidationLog_5TeV2015.json"       # log JSON
bestLumiFileName = "./normtag_BRIL_5TeV2015.json"       # best lumi JSON
lumiJSONFileNamePattern = "./normtag_%s_5TeV2015.json"  # filename pattern for individual luminometer JSONs
...
def makeEmails():
    ...
    defaultEmailBody = "Hello,\n\nThis is an automated email to let you know that the 2015 5TeV fill validation was performed for the following fill"+suffix+" by "+userName+":\n"
    ...
    for l in emailRecipients:
        ...
        # Don't bother sending out the individual mails for this
